...
final class CardContentView: UIView, NibLoadable {
    ...
    private func commonSetup() {
        ...
        imdbTitleLabel.layer.borderColor = Bundle.movieListBundleHelper.color(named: "subtitleText")?.cgColor
        ...
        closeButton.setImage(Bundle.movieListBundleHelper.image(named: "close"), for: .normal)
    }
