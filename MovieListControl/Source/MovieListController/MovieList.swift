...
struct Actor {
    ...
    static func generate() -> [Actor] {
        return [Actor(photo: MovieListBundleHelper.image(named: "actor1"),
                      name: "Keanu Reeves",
                      role: "John Wick",
                      age: "54",
                ...
                Actor(photo: MovieListBundleHelper.image(named: "actor2"),
                      name: "Halle Berry",
                      role: "Sofia",
                      age: "54",
                ...
                Actor(photo: MovieListBundleHelper.image(named: "actor3"),
                      name: "Chad Stahelski",
                      role: "Director",
                      age: "52",
    ...
    static func generate() -> MovieList {
        return MovieList(items: [
            ...
            MovieItem(title: NSLocalizedString("John Wick: Chapter 3", comment: ""),
                      image: MovieListBundleHelper.image(named: "cover1"),
                      midImage: MovieListBundleHelper.image(named: "coverMid1"),
                      imdb: "8.4",
                      ...
                      trailer: [Trailer(image: MovieListBundleHelper.image(named: "trailer1"), url: "", title: "Exlusive Trailer"), Trailer(image: MovieListBundleHelper.image(named: "trailer1"), url: "", title: "Official Trailer")],
                      photo: [Photo(image: MovieListBundleHelper.image(named: "photo1")), Photo(image: MovieListBundleHelper.image(named: "photo2")), Photo(image: MovieListBundleHelper.image(named: "photo1"))],
            ...
            MovieItem(title: NSLocalizedString("Spider-Man", comment: ""),
                      image: MovieListBundleHelper.image(named: "cover2"),
                      midImage: MovieListBundleHelper.image(named: "coverMid2"),
                      imdb: "7.4",
                      genre: "Action2, Crime, Thriller",
                      info: "USA, 2019  /  2h 10min  /  PG-16",
                      story: "In this third installment of the adrenaline-fueled action franchise, super-assassin John Wick (Keanu Reeves) returns with a $14 million price tag on his head and an army of bounty-hunting killers on his trail. After killing a member of the shadowy international assassin’s guild, the High Table, John Wick is excommunicado, but the world’s most ruthless hit men and women await his every turn.",
                      actor: Actor.generate(),
                      trailer: [Trailer(image: MovieListBundleHelper.image(named: "trailer1"), url: "", title: "Exlusive Trailer")],
                      photo: [Photo(image: MovieListBundleHelper.image(named: "photo1")), Photo(image: MovieListBundleHelper.image(named: "photo2")), Photo(image: MovieListBundleHelper.image(named: "photo1"))],
                      cinema: [Cinema(name: "AMC Lincoln Square 13",
                                      hallName1: "Hall #1 2D",
                                      hallName2: "Hall #2 3D",
            ...
            MovieItem(title: NSLocalizedString("Godzilla", comment: ""),
                      image: MovieListBundleHelper.image(named: "cover3"),
                      midImage: MovieListBundleHelper.image(named: "coverMid3"),
                      imdb: "5.4",
            ...
            MovieItem(title: NSLocalizedString("Dark Phoenix", comment: ""),
                      image: MovieListBundleHelper.image(named: "cover4"),
                      midImage: MovieListBundleHelper.image(named: "coverMid4"),
                      imdb: "5.5",
            ...
            MovieItem(title: NSLocalizedString("It: Chapter Two", comment: ""),
                      image: MovieListBundleHelper.image(named: "cover5"),
                      midImage: MovieListBundleHelper.image(named: "coverMid5"),
                      imdb: "8.4",
                      genre: "Action, Crime, Thriller",
                      info: "USA, 2019  /  2h 10min  /  PG-16",
                      story: "In this third installment of the adrenaline-fueled action franchise, super-assassin John Wick (Keanu Reeves) returns with a $14 million price tag on his head and an army of bounty-hunting killers on his trail. After killing a member of the shadowy international assassin’s guild, the High Table, John Wick is excommunicado, but the world’s most ruthless hit men and women await his every turn.",
            ...
            MovieItem(title: NSLocalizedString("Once Upon a Time in Hollywood", comment: ""),
                      image: MovieListBundleHelper.image(named: "cover6"),
                      midImage: MovieListBundleHelper.image(named: "coverMid6"),
                      imdb: "7.4",
                      genre: "Action, Crime, Thriller",
                      info: "USA, 2019  /  2h 10min  /  PG-16",
                      story: "In this third installment of the adrenaline-fueled action franchise, super-assassin John Wick (Keanu Reeves) returns with a $14 million price tag on his head and an army of bounty-hunting killers on his trail. After killing a member of the shadowy international assassin’s guild, the High Table, John Wick is excommunicado, but the world’s most ruthless hit men and women await his every turn.",
